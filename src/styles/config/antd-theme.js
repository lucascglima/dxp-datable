...
export const antdTheme = {
  ...
  components: {
    ...
    // ──────────────────────────────────────────
    // Card: {
    //   colorBgContainer: componentTokens.Card?.cardBg,
    //   colorBorderSecondary: componentTokens.Card?.cardBorderColor,
    //   borderRadius: componentTokens.Card?.cardBorderRadius,
    //   padding: componentTokens.Card?.cardPadding,
    //   paddingSM: componentTokens.Card?.cardPaddingSM,
    //   paddingLG: componentTokens.Card?.cardPaddingLG,
    // },
    ...
    // ──────────────────────────────────────────
    // Checkbox: {
    //   colorPrimary: componentTokens.Checkbox?.checkboxColor,
    //   colorBorder: componentTokens.Checkbox?.checkboxBorderColor,
    //   borderRadius: componentTokens.Checkbox?.checkboxBorderRadius,
    // },
    ...
    // ──────────────────────────────────────────
    // Collapse: {
    //   headerBg: componentTokens.Collapse?.collapseHeaderBg,
    //   headerPadding: componentTokens.Collapse?.collapseHeaderPadding,
    //   contentBg: componentTokens.Collapse?.collapseContentBg,
    //   contentPadding: componentTokens.Collapse?.collapseContentPadding,
    // },
    ...
    // ──────────────────────────────────────────
    // Divider: {
    //   colorSplit: componentTokens.Divider?.dividerColor,
    // },
    ...
    // ──────────────────────────────────────────
    // Form: {
    //   itemMarginBottom: componentTokens.Form?.formItemMarginBottom,
    //   labelHeight: componentTokens.Form?.formItemLabelHeight,
    //   labelColor: componentTokens.Form?.formLabelColor,
    //   verticalLabelPadding: componentTokens.Form?.formVerticalLabelPadding,
    // },

    // ──────────────────────────────────────────
    // INPUT NUMBER - Campos Numéricos
    // ──────────────────────────────────────────
    // InputNumber: {
    //   // Geralmente herda do Input, mas pode customizar
    //   controlHeight: componentTokens.InputNumber?.controlHeight,
    //   borderRadius: componentTokens.InputNumber?.borderRadius,
    // },
    ...
    // ──────────────────────────────────────────
    // Modal: {
    //   headerBg: componentTokens.Modal?.modalHeaderBg,
    //   contentBg: componentTokens.Modal?.modalHeaderBg,
    //   borderRadius: componentTokens.Modal?.modalBorderRadius,
    // },
    ...
    // ──────────────────────────────────────────
    // Radio: {
    //   colorPrimary: componentTokens.Radio?.radioPrimaryColor,
    //   colorBorder: componentTokens.Radio?.radioBorderColor,
    // },
    ...
    // ──────────────────────────────────────────
    // Select: {
    //   colorBgContainer: componentTokens.Select?.selectBg,
    //   colorBorder: componentTokens.Select?.selectBorderColor,
    //   controlHeight: componentTokens.Select?.selectHeightBase,
    //   controlHeightSM: componentTokens.Select?.selectHeightSM,
    //   controlHeightLG: componentTokens.Select?.selectHeightLG,
    // },
    ...
    // ──────────────────────────────────────────
    // Typography: {
    //   // Geralmente usa os tokens globais de tipografia
    //   fontFamily: globalThemeTokens.fontFamily,
    //   fontSize: globalThemeTokens.fontSize,
    // },
    ...
    // ──────────────────────────────────────────
    // Pagination: {
    //   itemSize: componentTokens.Pagination?.paginationItemSize,
    //   itemSizeSM: componentTokens.Pagination?.paginationItemSizeSM,
    //   fontSize: componentTokens.Pagination?.paginationFontSize,
    // },

    // ──────────────────────────────────────────
    // LAYOUT (Row/Col) - Grid System
    // ──────────────────────────────────────────
    // Row e Col usam os tokens globais de spacing e não precisam
    // de customização específica na maioria dos casos
  },
};
